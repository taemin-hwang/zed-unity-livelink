...
public class MyZEDSkeletonAnimator : MonoBehaviour
{
    ...
    public MyZEDBodyTrackingManager bodyTrackingManager;
    ...
    private MySkeletonHandler skhandler = null;
    public MySkeletonHandler Skhandler { get => skhandler; set => skhandler = value; }
    ...
    private void Awake()
    {
        bodyTrackingManager = (MyZEDBodyTrackingManager)FindObjectOfType(typeof(MyZEDBodyTrackingManager));
    ...
    void Start()
    {
        ...
        bodyTrackingFrequency = MyZEDBodyTrackingManager.BodyTrackingFrequency;
        smoothingFactor = MyZEDBodyTrackingManager.SmoothingFactor;
    }
